...
hadoop fs -mkdir $SAMPLE_DIR $JOB_DIR $LIB_DIR $DATA_DIR
...
echo "inputDir=$NAME_NODE_URL$DATA_DIR/earthquakes.csv" >> temp.job.properties
echo "esriGeometry=$NAME_NODE_URL$DATA_DIR/ca_counties.json" >> temp.job.properties
